...
resource "aws_s3_bucket" "cris-bronze_bucket" {
  bucket = "cris-utilidades-analise-bronze"
}

resource "aws_s3_bucket" "cris-silver_bucket" {
  bucket = "cris-utilidades-analise-silver"
}

resource "aws_s3_bucket" "cris-gold_bucket" {
  bucket = "cris-utilidades-analise-gold"
}

resource "aws_s3_bucket" "cris-utilidades-bucket" {
